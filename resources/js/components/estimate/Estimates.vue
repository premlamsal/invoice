          ...
          <div class="card shadow mb-4">
            ...
            <div class="card-body">
                ...
                <table class="table table-striped table-bordered" width="100%" cellspacing="0">
                  ...
                  <tbody>
                    <tr v-for="estimate in estimates" v-bind:key="estimate.id">
                      ...
                      <td><button style="margin-right: 5px;" class="btn btn-outline-primary" @click="showEstimate(estimate.id)"><span class="fa fa-align-justify"></span></button><button class="btn btn-outline-success" @click="editEstimate(estimate.id)" style="margin-right: 5px;"><span class="fa fa-edit"></span></button><button class="btn btn-outline-danger" @click="deleteEstimate(estimate.id)"><span class="fa fa-trash"></span></button></td>
                    </tr>
                  </tbody>
                </table>
              </div>
              <div class="row">
                <div class="col-md-8">
                    <ul class="pagination">
                      <li class="page-item" v-bind:class="{disabled:!pagination.first_link}"><button @click="fetchEstimates(pagination.first_link)" class="page-link">First</button></li>

                      <li class="page-item" v-bind:class="{disabled:!pagination.prev_link}"><button @click="fetchEstimates(pagination.prev_link)" class="page-link">Previous</button></li>

                      <li v-for="n in pagination.last_page" v-bind:key="n" class="page-item" v-bind:class="{active:pagination.current_page == n}"><button @click="fetchEstimates(pagination.path_page + n)" class="page-link">{{n}}</button></li>

                      <li class="page-item" v-bind:class="{disabled:!pagination.next_link}"><button @click="fetchEstimates(pagination.next_link)" class="page-link">Next</button></li>

                      <li class="page-item" v-bind:class="{disabled:!pagination.last_link}"><button @click="fetchEstimates(pagination.last_link)" class="page-link">Last</button></li>
                    </ul>
                </div>
                <div class="col-md-4">
